...
export default class TwitterApiv1ReadWrite extends TwitterApiv1ReadOnly {
  ...
  public async tweetThread(tweets: (SendTweetV1Params | string)[]) {
    ...
    for (const tweet of tweets) {
      ...
      const queryParams: SendTweetV1Params = {
  ...
  public reportUserAsSpam(options: ReportSpamV1Params) {
    return this.post<UserV1>("users/report_spam.json", {
      tweet_mode: "extended",
      ...options,
    });
  }
  ...
  public createFriendship(options: Partial<FriendshipCreateV1Params>) {
    return this.post<FriendshipCreateOrDestroyV1>(
   ...
   */
  public async updateAccountProfileBanner(
    file: TUploadableMedia,
    options: Partial<ProfileBannerUpdateV1Params> = {}
  ) {
    const queryParams = {
      banner: await readFileIntoBuffer(file),
      ...options,
    };
    return this.post<void>("account/update_profile_banner.json", queryParams, {
   ...
   */
  public async updateAccountProfileImage(
    file: TUploadableMedia,
    options: Partial<ProfileImageUpdateV1Params> = {}
  ) {
    const queryParams = {
      tweet_mode: "extended",
    ...
    return this.post<UserV1>("account/update_profile_image.json", queryParams, {
      forceBodyMode: "form-data",
    });
  }
  ...
  public createList(options: ListCreateV1Params) {
    return this.post<ListV1>("lists/create.json", {
      tweet_mode: "extended",
      ...options,
    });
  }
  ...
  public updateList(options: UpdateListV1Params) {
    return this.post<ListV1>("lists/update.json", {
      tweet_mode: "extended",
      ...options,
    });
  }
  ...
  public removeList(options: GetListV1Params) {
    return this.post<ListV1>("lists/destroy.json", {
      tweet_mode: "extended",
      ...options,
    });
  }
  ...
  public addListMembers(options: AddOrRemoveListMembersV1Params) {
    const hasMultiple =
      (options.user_id && hasMultipleItems(options.user_id)) ||
      (options.screen_name && hasMultipleItems(options.screen_name));
  ...
  public subscribeToList(options: GetListV1Params) {
    return this.post<ListV1>("lists/subscribers/create.json", {
      tweet_mode: "extended",
      ...options,
    });
  }
  ...
  public unsubscribeOfList(options: GetListV1Params) {
    return this.post<ListV1>("lists/subscribers/destroy.json", {
      tweet_mode: "extended",
      ...options,
    });
  }
  ...
  public createMediaMetadata(
    mediaId: string,
    metadata: Partial<MediaMetadataV1Params>
  ) {
  ...
  public async uploadMedia(
    ...
    const { fileHandle, mediaCategory, fileSize, mimeType } =
    ...
    try {
      ...
      const mediaData = await this.post<InitMediaV1Result>(
        UPLOAD_ENDPOINT,
        {
          ...
          media_type: mimeType,
          media_category: options.mediaCategory ?? mediaCategory,
  ...
  protected async awaitForMediaProcessingCompletion(
    fullMediaData: MediaStatusV1Result
  ) {
  ...
  protected async getUploadMediaRequirements(
    file: TUploadableMedia,
    { mimeType, type, target, longVideo }: Partial<UploadMediaV1Params> = {}
  ) {
    // Get the file handle (if not buffer)
    ...
    try {
      ...
      if (
        realMimeType === EUploadMimeType.Mp4 &&
  ...
  protected async mediaChunkedUpload(
    ...
    const buffer =
      fileHandle instanceof Buffer ? undefined : Buffer.alloc(chunkLength);
    ...
    [readBuffer, nread] = await readNextPartOf(
      fileHandle,
      chunkLength,
      offset,
      buffer
